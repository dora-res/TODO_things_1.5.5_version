    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        add_repeat_task.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(requireContext().openFileOutput
                            ("listRepitersTasks.txt", MODE_PRIVATE)));
                    bw.write(a);
                    bw.close();
                } catch (IOException e) {
                    e.printStackTrace();
                ...
                try {
                    BufferedReader br = new BufferedReader(new InputStreamReader(requireActivity()
                            .openFileInput("listRepitersTasks.txt")));
                    String str = "";
                    while ((str = br.readLine())!= null){
                        repeat_tasks.append(str);
                    }
                } catch (IOException e) {
                    e.printStackTrace();
                }
        ...
        delete_repeat_task.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(requireContext().openFileOutput("listRepitersTasks.txt", MODE_PRIVATE)));
                    bw.write("");
                    bw.close();
                } catch (IOException e) {
                    e.printStackTrace();
